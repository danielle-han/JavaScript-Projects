...
function placeXOrO(squareNumber){
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = "O";
        //if actve play is anything other than X
        } else {
...
function checkWinConditions() {
    ...
    //this condition checks for a tie. if none of the above conditions registar and 9
    //squares are selected the code executes.
    else if (selectedSquares.length >= 9) {
        //this function plays the tie game sound.
        audio('./media/tie.mp3');
        //this function sets a .3 second timer before the resentGame is called.
        setTimeout(function () { resetGame(); }, 1000);
    } 

    //this function checks if an array includes 3 strings. it is used to check for each win cndition.
    function arrayIncludes(squareA, squareB, squareC) {
        //these 3 vars will be used to check for 3 in a row
        const a = selectedSquares.includes(squareA);
        const b = selectedSquares.includes(squareB);
        const c = selectedSquares.includes(squareC);
        //if the 3 vars we pass are all incl in our array - true is 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //this line indicates - end of a lines x axis is
        x2 = coordX2,
        //this line indicates - end of a lines y axis is
        y2 = coordY2,
        //this var stores temporary x axis data we update in animation loop
        x = x1,
    ...
    function animateLineDrawing(){
        ...
        c.stroke();
        //this condition checks if we have reached the endpoit
        if (x1 <= x2 && y1 <= y2) {
            //this condition adds 10 to the previous end x point
            if (x < x2) { x += 10; }
            //this condition adds 10 to prev end y point
            if (y < y2) { y += 10; }
...
//this function resets game in event of a tie or win
function resetGame() {
